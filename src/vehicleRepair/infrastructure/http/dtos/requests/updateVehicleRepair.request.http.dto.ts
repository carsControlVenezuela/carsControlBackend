...
import { UpdateVehicleRepairInputDto } from '../../../../application/dtos/requests/updateVehicleRepair.request.dto';

export class UpdateVehicleRepairRequestDTO implements UpdateVehicleRepairInputDto {
    ...
    @IsOptional({ message: 'La ubicación es opcional' })
