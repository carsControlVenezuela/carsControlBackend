...
import { UpdateParishRequestDto } from '../../../../application/dtos/requests/updateParish.request.dtos';

export class UpdateParishRequestDTO implements UpdateParishRequestDto {
